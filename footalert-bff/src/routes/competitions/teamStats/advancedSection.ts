...
import type {
  CompetitionComputedRow,
  CompetitionTeamAdvancedRow,
  CompetitionTeamAdvancedSection,
  TeamStatisticPayload,
  TeamStatsAvailabilityReason,
  TeamStatsAvailabilityState,
  TeamStatsQueryResult,
} from './contracts.js';
...
export function buildUnavailableAdvancedSection(
  reason: Exclude<TeamStatsAvailabilityReason, null>,
): CompetitionTeamAdvancedSection {
  return {
...
export async function buildCompetitionAdvancedSection(
  leagueId: string,
  season: number,
  computedRows: CompetitionComputedRow[],
): Promise<CompetitionTeamAdvancedSection> {
