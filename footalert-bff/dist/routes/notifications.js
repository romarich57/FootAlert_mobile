...
import { notificationAlertTypes, notificationScopeKinds, } from '../lib/notifications/contracts.js';
import { hashPushToken, encryptPushToken, } from '../lib/notifications/crypto.js';
import { getNotificationsMetricsSnapshot, incrementNotificationMetric, } from '../lib/notifications/metrics.js';
import { getNotificationsQueueClient, getNotificationsStore, resetNotificationsRuntimeForTests, } from '../lib/notifications/runtime.js';
...
function verifyIngestAuth(request) {
...
function assertNotificationsBackendEnabled() {
...
export async function resetPushTokenStoreForTests() {
...
export async function registerNotificationsRoutes(app) {
    ...
    app.post('/v1/notifications/tokens', {
        ...
        const tokenCiphertext = encryptPushToken(payload.token, env.pushTokenEncryptionKey);
