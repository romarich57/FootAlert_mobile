...
function getFixtureTimestamp(fixture, originalIndex) {
...
function normalizeOrderedFixtures(items) {
...
export function buildOrderedFixtureRounds(items) {
...
export function flattenOrderedFixtureRounds(rounds) {
