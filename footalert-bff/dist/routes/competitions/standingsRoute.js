...
export function registerCompetitionStandingsRoute(app) {
    app.get('/v1/competitions/:id/standings', {
        ...
        return withCache(cacheKey, 90_000, () => apiFootballGet(`/standings?league=${encodeURIComponent(params.id)}&season=${encodeURIComponent(String(query.season))}`));
    });
}
