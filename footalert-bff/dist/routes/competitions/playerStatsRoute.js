...
export function registerCompetitionPlayerStatsRoute(app) {
    app.get('/v1/competitions/:id/player-stats', {
        ...
        return withCache(cacheKey, 5 * 60_000, () => apiFootballGet(buildPlayerStatsPath(query.type, params.id, query.season)));
    });
}
