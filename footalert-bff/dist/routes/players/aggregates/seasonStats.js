...
export function normalizeRating(value, precision = 2) {
...
export function sumOrNull(first, second) {
    if (first === null && second === null) {
        return null;
    }
    return (first ?? 0) + (second ?? 0);
}
export function resolvePrimaryStatistic(statistics, season) {
...
export function resolveSeasonStatistics(statistics, season) {
    if (!statistics || statistics.length === 0) {
        return [];
    }
    const seasonScoped = typeof season === 'number'
...
export function aggregateSeasonStats(statsRows) {
    ...
    let penaltyGoals = null;
    let passes = null;
    let keyPasses = null;
    let dribblesAttempts = null;
    let dribblesSuccess = null;
    let tackles = null;
    let interceptions = null;
    let blocks = null;
    let duelsTotal = null;
    let duelsWon = null;
    ...
    let redCards = null;
    let dribblesBeaten = null;
    let savesTotal = null;
    let goalsConceded = null;
    let penaltiesWon = null;
    let penaltiesMissed = null;
    let penaltiesCommitted = null;
    ...
    return {
        ...
        penaltyGoals,
        passes,
        passesAccuracy: passesAccuracyWeight > 0
...
function groupStatsByCompetition(statsRows) {
...
function compareCompetitionStats(first, second) {
...
export function mapPlayerDetailsToSeasonStatsDataset(dto, season) {
