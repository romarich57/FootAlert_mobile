...
import { fetchFixtureContext, toDateMilliseconds, toEpochMilliseconds, toNumericId, } from './fixtureContext.js';
import { emptyQuerySchema, headToHeadQuerySchema, matchByIdParamsSchema, matchByIdQuerySchema, matchPlayersStatsParamsSchema, matchStatisticsQuerySchema, optionalTimezoneQuerySchema, } from './schemas.js';
import { filterFixtureStatisticsByPeriod } from './statistics.js';
export function registerMatchDetailRoutes(app) {
