...
function toInjuryFixtureId(value) {
...
function toInjuryFixtureDateMs(value) {
    if (!value || typeof value !== 'object') {
        return null;
    }
    const record = value;
...
function toInjuryPlayerName(value) {
    if (!value || typeof value !== 'object') {
        return '';
    }
    const record = value;
...
function sortInjuriesByDate(entries) {
...
export function filterInjuriesForMatch(entries, matchFixtureId, matchFixtureDateMs) {
    if (entries.length === 0) {
        return [];
    }
