...
function resolveCacheControl(routePath) {
    if (!routePath) {
        return undefined;
    }
...
async function registerCompression(app) {
    ...
    try {
        ...
        const compressPlugin = compressModule.default;
        ...
        app.log.warn({ error, plugin: compressModuleName }, 'Compression plugin unavailable, using built-in gzip fallback.');
    }
