...
const DEFAULT_MOBILE_ENABLE_BFF_TEAM_FULL = true;
const DEFAULT_MOBILE_ENABLE_BFF_PLAYER_FULL = true;
const DEFAULT_MOBILE_ENABLE_BFF_COMPETITION_FULL = true;
const DEFAULT_MOBILE_ENABLE_BFF_MATCH_FULL = true;
const DEFAULT_MOBILE_ENABLE_SQLITE_LOCAL_FIRST = true;
