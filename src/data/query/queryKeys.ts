...
export const queryKeys = {
  ...
  teams: {
    ...
    ) => ['teams', 'full', teamId, timezone, leagueId, season] as const,
    overview: (
      teamId: string,
  ...
  players: {
    full: (playerId: string, season: number) => ['players', 'full', playerId, season] as const,
  ...
  matchesFull: (matchId: string, timezone: string) =>
    ['match_details_full', matchId, timezone] as const,
};
